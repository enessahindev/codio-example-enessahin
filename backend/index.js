...
//mongoDBConnection
const uri =
  "mongodb+srv://eComAdmin:BlrSPbc6AE7UDq0D@cluster0.3olludj.mongodb.net/?retryWrites=true&w=majority";
//Use of mongoose
mongoose
  .connect(uri, {
...
app.post("/products/update", async (req, res) => {
  try {
    const { _id, name, categoryName, stock, price } = req.body;
    let product = await Product.findByIdAndUpdate(_id, name, categoryName, stock, price);
